...
instance_create(x,y,menuSelect2)
instance_destroy()
exit;
}
...
global.minu[i]=global.atime[i] div 60;
global.sec[i]=global.atime[i] mod 60;

draw_text(x+(i-1)*239+10,y+90,"time:"+string(global.hour[i])+":"+string(global.minu[i])+":"+string(global.sec[i]));
